...
public interface DisambiguationStrategy {
	...
	public static final DisambiguationStrategy SIMPLE = new DisambiguationStrategy(){
		@Override
	...
	public static final DisambiguationStrategy MIN_UNPARSED = new DisambiguationStrategy() {			
		@Override
		public List<Pair<String, ? extends Object>> choose(
				List<List<Pair<String, ? extends Object>>> trees) {
